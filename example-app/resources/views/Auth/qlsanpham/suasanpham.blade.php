    ...
    @if (Auth::guard('api')->check())
            <div>
                ...
                <form method="post" action="/Administrator/themsanpham" enctype="multipart/form-data" >
                    ...
                    <div class="my-3">        
                        <input class="form-control" value="{{ $sanpham -> gia }}" type="number" name="txtgia" placeholder="Giá" required>
                    </div>             
                    <div class="my-3">        
                        <input class="form-control" value="{{ $sanpham -> hinh }}" type="file" name="txthinh"  required>
                    </div>
                    <div class="my-3">        
